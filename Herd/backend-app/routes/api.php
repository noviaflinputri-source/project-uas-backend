...
use App\Http\Controllers\API\InformationController; // Pastikan namespace API ikut terpanggil
...
// Akses Baca Informasi dibuka secara publik agar langsung muncul di React
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Rute Tulis Informasi (POST, PUT, DELETE) diamankan di sini
